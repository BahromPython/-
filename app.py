...
# Настройка CORS: разрешаем запросы с фронтенда на Render
CORS(app, resources={r"/*": {"origins": ["https://your-frontend-name.onrender.com", "http://localhost:8000", "http://127.0.0.1:5000", "null"]}})
